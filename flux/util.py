...
configs = {
    "flux-dev": ModelSpec(
        repo_id="/mnt/d/USO/weights/FLUX.1-dev",
        repo_id_ae="/mnt/d/USO/weights/FLUX.1-dev",
    ...
    "flux-dev-fp8": ModelSpec(
        repo_id="weights/FLUX.1-dev",
        repo_id_ae="weights/FLUX.1-dev",
        repo_flow="flux1-dev.safetensors",
        repo_ae="ae.safetensors",
...
def load_flow_model(
    ...
    ckpt_path = "/mnt/d/USO/weights/FLUX.1-dev/flux1-dev.safetensors"
    if (
        ckpt_path is None
...
def load_flow_model_only_lora(
    ...
    # Loading Flux
    # ckpt_path = configs[name].ckpt_path
    ckpt_path = "/mnt/d/bzh/emostyle/weights/FLUX.1-dev/flux1-dev.safetensors"
    if (
        ckpt_path is None
        and configs[name].repo_id is not None
        and configs[name].repo_flow is not None
    ...
    if hf_download:
        try:
            ...
            # )
            lora_ckpt_path = "/mnt/d/bzh/emostyle/USO/uso_flux_v1.0/dit_lora.safetensors"
        ...
        try:
            ...
            # )
            proj_ckpt_path = "/mnt/d/bzh/emostyle/USO/uso_flux_v1.0/projector.safetensors"
        except Exception as e:
...
def load_t5(device: str | torch.device = "cuda", max_length: int = 512) -> HFEmbedder:
    ...
    version = os.environ.get("T5", "weights/t5-xxl")
...
def load_clip(device: str | torch.device = "cuda") -> HFEmbedder:
    version = os.environ.get("CLIP", "weights/clip-vit-l14")
...
def load_ae(
    ...
    ckpt_path = "/mnt/d/bzh/emostyle/weights/FLUX.1-dev/ae.safetensors"
    if (
        ckpt_path is None
        and configs[name].repo_id is not None
